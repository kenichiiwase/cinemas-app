        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, db
                            .collection("users")
                            .findOne({ email: username, password: hash_1.default.digest(password) })];
                case 2:
                    userData_1 = _b.sent();
                    if (userData_1) {
                        // セッションIDの張替え
...
var initialize = function () {
    return [passport_1.default.initialize(), passport_1.default.session()];
};
